...
def imt_get(b):
    return dict(
        ...
        pl=scals(b, "pred_leaf")[0], pp=arrs(b, "pred_path")[0], pib=arrs(b, "pred_index_bits")[0])
...
def lift_pt(note_root, rho, sk, nonce, npath, nbit, I, nf, ain, amt, aout, mout, otag, ctag, oleaf):
    return "\n".join([
        ...
        f'pred_leaf = "{I["pl"]}"', f'pred_path = {I["pp"]}', f'pred_index_bits = {I["pib"]}',
...
match_lines = [
    ...
    f't_pred_leaf = "{MTI["pl"]}"', f't_pred_path = {MTI["pp"]}', f't_pred_index_bits = {MTI["pib"]}',
    ...
    f'm_pred_leaf = ["{MMI["pl"]}", "0", "0"]',
    f'm_pred_path = {a3(MMI["pp"], ZHEX)}', f'm_pred_index_bits = {a3(MMI["pib"], ZBITS)}',
...
join_lines = [
    ...
    f'pred1_leaf = "{J1["pl"]}"', f'pred1_path = {J1["pp"]}', f'pred1_index_bits = {J1["pib"]}',
    ...
    f'pred2_leaf = "{J2["pl"]}"', f'pred2_path = {J2["pp"]}', f'pred2_index_bits = {J2["pib"]}',
...
unshield_lines = [
    ...
    f'pred_leaf = "{UI["pl"]}"', f'pred_path = {UI["pp"]}', f'pred_index_bits = {UI["pib"]}',
...
cancel_lines = [
    ...
    f'pred_leaf = "{EI["pl"]}"', f'pred_path = {EI["pp"]}', f'pred_index_bits = {EI["pib"]}',
...
wmatch_lines = [
    ...
    f't_pred_leaf = "{WTI["pl"]}"', f't_pred_path = {WTI["pp"]}', f't_pred_index_bits = {WTI["pib"]}',
    ...
    f'm_pred_leaf = {t3(*[chr(34) + I["pl"] + chr(34) for I in mimt])}',
    f'm_pred_path = {t3(*[I["pp"] for I in mimt])}',
    f'm_pred_index_bits = {t3(*[I["pib"] for I in mimt])}',
...
life_lines = [
    ...
    f'pred_leaf = "{GI["pl"]}"', f'pred_path = {GI["pp"]}', f'pred_index_bits = {GI["pib"]}',
