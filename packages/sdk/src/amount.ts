 ...
 * (an i128, e.g. 1 XLM = 10_000_000 stroops at 7 decimals); UIs only ever show and accept
 * human-readable decimal amounts. Notes keep the raw value as their canonical representation.
 *
 * Ported verbatim from the frontend `amount.ts` (pure, no browser APIs).
 */
 ...
 * rendered with up to `places` fractional digits. Returns null when base is zero.
 */
